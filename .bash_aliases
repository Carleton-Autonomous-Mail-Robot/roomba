...
alias ps='ps aux'
alias pull_project='cd ~/create_ws/src/roomba;git stash; git stash drop; git pull; chmod +x ~/create_ws/src/roomba/scripts/*.py; cd ~/create_ws/src/roomba; cp .bash_aliases ~/.bash_aliases; cd ~/'
