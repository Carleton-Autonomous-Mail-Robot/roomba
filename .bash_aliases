...
alias ps='ps aux'
alias pull_project='cd ~/create_ws/src/roomba;git stash; git stash drop;git checkout development; git pull; chmod +x ~/create_ws/src/roomba/scripts/*.py; cd ~/create_ws/src/roomba; cp .bash_aliases ~/.bash_aliases; cd ~/'
alias T1='sudo usermod -a -G dialout $USER; cd ~/create_ws; source devel_isolated/setup.bash; roslaunch ca_driver create_2.launch;'
alias T1R2='sudo usermod -a -G dialout $USER; cd ~/create_ws; source devel_isolated/setup.bash; roslaunch ca_driver create_1.launch;'
