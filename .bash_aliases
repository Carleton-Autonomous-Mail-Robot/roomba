...
alias T4='cd ~/create_ws; source devel/setup.bash; rosrun saviRoomba logger.py;'
alias T5='cd ~/create_ws; source devel/setup.bash; rosrun saviRoomba userInterface.p;'
